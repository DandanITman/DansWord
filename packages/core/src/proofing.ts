/**
 * Proofing rules: the parts of Word's spelling, grammar and AutoCorrect
 ...
 * English writing. Word ships thousands; these are the ones a user actually
 * notices missing.
 */
 ...
 * matching Word. Replacements that are themselves capitalised ("I've") keep
...
/**
 * The AutoFormat replacements Word applies to punctuation as you type:
...
/** Word phrases that are simply wrong, with the correction Word offers. */
...
/** Readability statistics, as Word's Word Count and readability panel show. */
