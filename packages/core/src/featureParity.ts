...
export const FEATURE_PARITY: ParityFeature[] = [
  ...
  { id: 'file.dansword', name: 'Native .dansword format', category: 'file', status: 'implemented', word: false, openOffice: false, notes: 'Alternate native format with version history' },
  { id: 'file.docx', name: 'DOCX import/export (default save)', category: 'file', status: 'implemented', word: true, openOffice: true },
