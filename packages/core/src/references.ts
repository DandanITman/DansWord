...
export interface CitationSource {
  ...
  url?: string;
  accessed?: string;
  /** The short tag Word puts in the document, e.g. "Knu86". */
  tag: string;
}
...
/** The tag Word generates for a new source: first three letters plus the year. */
...
/** Cross-reference targets Word offers. */
