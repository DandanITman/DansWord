...
const ALLOWED = new Map([
  [
    ...
    'the em dash the Symbol picker offers the user to insert, as Word does',
  ],
  [
    'packages/core/src/proofing.ts',
    "Word's AutoCorrect rule turning \"--\" into an em dash, and the dash characters that mark an opening smart quote",
  ],
  [
