...
/**
 * The run-level formatting Word's Font group offers beyond bold and italic:
...
/** Word's font size list, plus the sizes its Grow/Shrink buttons step through. */
...
export const CharacterFormatting = Extension.create({
    ...
    return [
      {
        ...
        attributes: {
          ...
          /** Word's inline equation runs: serif italic, like its linear format. */
          equation: {
            default: null,
  ...
  addKeyboardShortcuts() {
    return {
      // Word's Grow Font / Shrink Font shortcuts.
