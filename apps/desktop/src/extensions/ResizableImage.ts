...
/** Word's Wrap Text choices, in the order the menu lists them. */
...
/** Picture Format > Position: Word's nine-cell "Position in Text Wrapping". */
...
export const ResizableImage = Image.extend({
  ...
  addCommands() {
    return {
      ...
      /** Arrow-key nudging, as Word moves a selected picture. */
      nudgeImage:
        (dx: number, dy: number) =>
        ({ editor, commands }) => {
