 ...
 * Line and the rules - because that is what they are in Word: fields. Splitting
...
export interface MergePreviewState {
  active: boolean;
  /** Word's Highlight Merge Fields toggle. */
  highlight: boolean;
...
export const MergeField = Node.create({
   ...
   * «FieldName» - which is exactly what Word shows, and is legible rather than
