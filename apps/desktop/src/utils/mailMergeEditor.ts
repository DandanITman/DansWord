 ...
 *
 * Word's Labels tab offers this for the "thirty copies of my own return address"
...
/**
 * Word's Update Labels: copy the first cell across the sheet, giving every later
