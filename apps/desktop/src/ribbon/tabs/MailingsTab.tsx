...
/**
 * Word's Mailings tab, group for group: Create, Start Mail Merge, Write & Insert
 * Fields, Preview Results, Finish.
 *
 * The disabled states are the part worth being careful about, because they are
 * how Word teaches the workflow. Everything from Edit Recipient List rightwards
 ...
 *
 * Envelopes and Labels are the exception, and deliberately so: in Word they
...
/** Word lists the merge types in this order, with Normal last. */
...
export function MailingsTab({ actions, flags }: RibbonTabProps) {
  ...
  /* Preview stepping is meaningless with nothing to step through, and Word
  ...
  return (
    <>
      ...
      <RibbonGroup label="Write &amp; Insert Fields">
        ...
        <RibbonStack>
          {/* Word's split button: the face opens the full list, the chevron
      ...
      <RibbonGroup label="Preview Results">
        ...
        <RibbonStack>
          {/* The record navigator, laid out as Word's is: ends outside,
